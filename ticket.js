...
どんな些細なご質問・お問い合わせでも、管理者が丁寧に対応させていただきます。ご気軽にご利用ください。`
        )
        .setColor(0x4aa3ff);
...
下のボックスからご質問・お問い合わせ内容を選択してください。`
    ...
    // セレクト
      ...
      const map = {
        rewasd: "reWASDに関するご質問・お問い合わせ",
        steam_jitter: "Steamジッターマクロに関するご質問・お問い合わせ",
        other: "上記に当てはまらないご質問・お問い合わせ"
      };

      await interaction.reply({
        content: `選択: ${map[interaction.values[0]]}`,
        ephemeral: true
      });
    }
  });
